...
<head>
    ...
    <script type="text/javascript">
        ...
        function serachKeyword() {
            window.location.href = "/list?keyWord=" + $("#keyword").val();
        }
        ...
        function fqBrand(id) {
            //判断是否有价格
            if (price != '') {
                window.location.href = "/list?keyWord=" + keyword + "&brandId=" + id + "&price=" + price;
            } else {
                window.location.href = "/list?keyWord=" + keyword + "&brandId=" + id;
            }
        }
        ...
        function fqPrice(id) {
            if (brandId != '') {
                window.location.href = "/list?keyWord=" + keyword + "&brandId=" + brandId + "&price=" + id;
            } else {
                window.location.href = "/list?keyWord=" + keyword + "&price=" + id;
            }
        }
                            ...
                            <ul class="J_valueList v-fixed">
                                <c:forEach items="${brands}" var="brand">
                                    <li id="brand-38118" data-initial="j" style="display:block;">
                                        <a href="javascript:;" onclick="fqBrand('${brand.id}')" title="${brand.name }"><i></i>${brand.name }
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
                        ...
                        <div class="ml-wrap">
                            <div id="J_filter" class="filter">
                                <div class="f-line top">
                                    <div class="f-sort"><a href="javascript:;" class="curr">综合排序<i></i></a><a
                                            href="javascript:;" class="">销量<i></i></a><a href="javascript:;" class="">价格<i></i></a><a
                                            href="javascript:;" class="">评论数<i></i></a><a href="javascript:;" class="">新品<i></i></a>
                                    </div>
                                    <div class="f-search">
                            ...
                            <div class="page pb15">
                                <div class="r inb_a page_b" style="float: right;">
                                    <c:forEach items="${productList.pageView }" var="page">
                                        ${page }
                                    </c:forEach>
                                </div>
                            </div>
