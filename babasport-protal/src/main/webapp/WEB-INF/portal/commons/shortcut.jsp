...
<script>
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.error == -1 || result.error == 1) {
                    var htm = "<a href='javascript:;' onclick='logins()'>[登录]</a>&nbsp;<a href='javascript:;' onclick='regist()'>[免费注册]</a>"
                    $("#loginbar").append(htm)
                } else if (result.error == 0) {
                    var htm = "<a href='javascript:;' onclick='logout()'>[退出]</a>&nbsp;<a href='javascript:;' onclick'myOrder()'>我的订单</a>"
    ...
    function logins() {
        window.location.href = "http://localhost:8085/login.aspx?returnUrl=" + encodeURIComponent(window.location.href);
    }
</script>
