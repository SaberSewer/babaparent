			...
			if(ref == '#tab_3'){
				// 编辑器参数
		 		var kingEditorParams = {
					...
					//指定上传文件请求的url。
					uploadJson : '/product/product_eidt_upload.do',
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/product/product_add.do" method="post" enctype="multipart/form-data">
					...
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						颜色:</td><td width="80%" class="pn-fcontent">
							<c:forEach items="#{color}" var="co">
								<input type="checkbox" value="${co.id}" name="colors"/>${co.name}
							</c:forEach>
					</td>
				</tr>
				<tr>
